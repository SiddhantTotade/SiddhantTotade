...
<div style="display: flex; gap: 20px;" align="center">
    <img align="center" src="https://skillicons.dev/icons?i=cpp,python,html,css,js,react,redux,materialui,tailwindcss,django,sqlite,postgresql,mysql,heroku,netlify,docker" height="80"/>
    &nbsp;
    &nbsp;
    &nbsp;
    &nbsp;
